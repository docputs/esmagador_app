...
mixin _$AuthFailure {
  ...
  Result map<Result extends Object>({
    @required Result emptyField(_EmptyField value),
    @required Result displayNameTooLong(_DisplayNameTooLong value),
    @required Result emailAlreadyInUse(_EmailAlreadyInUse value),
    @required Result cancelledByUser(_CancelledByUser value),
    @required Result invalidEmailAddress(_InvalidEmailAddress value),
    @required
        Result invalidEmailAndPasswordCombination(
            _InvalidEmailAndPasswordCombination value),
    @required Result emailBadlyFormatted(_EmailBadlyFormatted value),
  ...
  Result maybeMap<Result extends Object>({
    Result emptyField(_EmptyField value),
    Result displayNameTooLong(_DisplayNameTooLong value),
    Result emailAlreadyInUse(_EmailAlreadyInUse value),
    Result cancelledByUser(_CancelledByUser value),
    Result invalidEmailAddress(_InvalidEmailAddress value),
    Result invalidEmailAndPasswordCombination(
        _InvalidEmailAndPasswordCombination value),
    Result emailBadlyFormatted(_EmailBadlyFormatted value),
